...
class Transaction implements TransactionInterface {
    ...
    /** @var string */
    protected $recipientBankCode;

    /** @var string */
    protected $recipientBankName;
    ...
    protected function __construct($id, $date, $amount, $currency, $senderAccountNumber, $senderBankCode, $senderBankName, $constantSymbol, $variableSymbol, $specificSymbol, $userIdentity, $userMessage, $transactionType, $performedBy, $comment, $paymentOrderId)
    {
        $this->id = $id;
        $this->date = $date;
        $this->amount = $amount;
